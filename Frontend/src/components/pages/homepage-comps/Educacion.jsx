...
import CertificateModal from './ModalAllProject';
    ...
    return (
        <section name='Education' className='relative w-full h-unset md:h-screen text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <div className='mb-2'>
                    <h2 className='text-4xl font-bold inline border-b-4 border-purple-600 sm:text-5xl pb-1'>Education</h2>
            ...
            <ScrollLink to="Contact" smooth duration={500} className='absolute bottom-2 -left-full md:left-1/2 md:-translate-x-1/2 cursor-pointer hover:text-primary-color'>
                <i className='bx bx-chevron-down  text-7xl text-gray-600 animate-bounce font hover:text-purple-600'></i>
            </ScrollLink>
