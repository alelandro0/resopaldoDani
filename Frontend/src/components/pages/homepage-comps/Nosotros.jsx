    ...
    return (
        ...
        className='relative w-full md:h-screen text-white h-unset'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg'>
                    ...
                    <div className='pb-8'>
                        <h2 className='text-4xl sm:text-5xl font-bold inline border-b-4 border-purple-600 '>Acerca de Nosotros</h2>
                    </div>
                    ...
                    <Link to='/about-me' className='text-white font-semibold text-[16px] w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-t from-purple-600  cursor-pointer mx-auto md:mx-0 self-end mt-8 hover:scale-110 duration-300'>
                        Ver mas
